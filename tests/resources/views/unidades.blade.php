                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Unidades Medicas</h4>
                        </div><!-- end card header -->
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="email">Limite Donaciones por Dia</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            <tr>
                                                ...
                                                <td class="customer_name">IMSS 1</td>
                                                <td class="email">10</td>
                                                <td class="phone">googleMaps.com</td>
