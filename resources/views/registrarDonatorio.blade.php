...
<head>
    <!-- Meta y títulos -->
    <meta charset="utf-8" />
    <title>Registrar Donatorio</title>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Registro Nuevo Donatorio</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="live-preview">
                                <form class="row g-3">
                                    <div class="col-md-4">
                                        <label for="validationDefault01" class="form-label">CURP</label>
                                        <input type="text" class="form-control" id="validationDefault01" value="Escribir CURP" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="validationDefault02" class="form-label">Nombre Completo</label>
                                        <input type="text" class="form-control" id="validationDefault02" value="Pedrito" required>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                    <label for="validationDefault04" class="form-label">Unidades de Sangre Requeridas</label>
                                        <select class="form-select" id="validationDefault04" required>
                                            <option selected disabled value="">Opciones...</option>
                                            <option>1</option>
                                            <option>2</option>
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-danger" type="submit">Solicitar</button>
                                    </div>
                                </form>
                            </div>
