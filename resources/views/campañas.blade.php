                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <button type="button" class="btn btn-danger add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#addModal"><i class="ri-add-line align-bottom me-1"></i> Añadir</button>
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="email">Inicio Campaña</th>
                                                <th class="sort" data-sort="phone">Fin Campaña</th>
                                                <th class="sort" data-sort="date">Sangre Buscada</th>
                                                <th class="sort" data-sort="date">Donaciones Requerridas</th>
                                                <th class="sort" data-sort="date">Donaciones Actuales</th>
                                                <th class="sort" data-sort="date">Acciones</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            <tr>
                                                ...
                                                <td class="customer_name">CAMPAÑA JORGE</td>
                                                <td class="email">20/11/23</td>
                                                <td class="phone">21/11/23</td>
                                                <td class="phone">A+</td>
                                                <td class="phone">10</td>
                                                <td class="phone">0 :c</td>
